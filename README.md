...
|------|-------------|------|---------|:--------:|
| <a name="input_codecommit_repo_arn"></a> [codecommit\_repo\_arn](#input\_codecommit\_repo\_arn) | ARN of the CodeCommit repository which will be updated by the pipeline | `string` | n/a | yes |
